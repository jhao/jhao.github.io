...
(function () {
  const translations = {
    en: {
      ...
      'toolbox.checkin.subtitle': 'Event Attendance Tracker',
      'toolbox.checkin.title': 'Check-in Status Board',
      'toolbox.checkin.description': 'A compact app for reviewing event participants, arrivals, and check-in progress at a glance.',
      'toolbox.checkin.link': 'View check-ins',
      'toolbox.morse.subtitle': 'Morse Code Learning',
      'toolbox.morse.title': 'Morse Quick Start',
      'toolbox.morse.description': 'A lightweight Morse code trainer for learning dot-dash rhythm and encoding rules quickly.',
      'toolbox.morse.link': 'Start learning',
      'toolbox.factory.subtitle': 'ERP & MES Demo',
      'toolbox.factory.title': 'Smart Factory Demo',
      'toolbox.factory.description': 'An ERP and MES feature demo for smart factories, covering production, materials, and shop-floor coordination.',
      'toolbox.factory.link': 'View demo',
      ...
      'toolbox.gameTool.subtitle': 'Card Counting Assistant',
      'toolbox.gameTool.title': 'Game Tool',
      'toolbox.gameTool.description': 'Track cards and calculate odds for Go, Chinese chess, Texas Hold’em, Guandan, and Mahjong.',
      'toolbox.gameTool.link': 'Open tool',
      'toolbox.sixPoker.subtitle': 'Tianjin Classic Card Game',
      'toolbox.sixPoker.title': 'Six Poker',
      'toolbox.sixPoker.description': 'A playful Tianjin classic called “Da Liu Jia” (Six Poker), with both single-player and online multiplayer modes.',
      'toolbox.sixPoker.link': 'Enter game',
    ...
    zh: {
      ...
      'toolbox.checkin.subtitle': '活动签到盘点',
      'toolbox.checkin.title': '签到状态盘点',
      'toolbox.checkin.description': '活动人员盘点签到状态小应用，便于快速核对参与者到场与签到进度。',
      'toolbox.checkin.link': '查看签到',
      'toolbox.morse.subtitle': '摩斯密码学习',
      'toolbox.morse.title': '摩斯密码速成',
      'toolbox.morse.description': '摩斯密码快速掌握小应用，通过轻量练习帮助理解点划节奏与编码规则。',
      'toolbox.morse.link': '开始学习',
      'toolbox.factory.subtitle': 'ERP 与 MES 演示',
      'toolbox.factory.title': '智能工厂演示',
      'toolbox.factory.description': '智能工厂 ERP 与 MES 功能演示，展示生产、物料与现场协同的核心流程。',
      'toolbox.factory.link': '查看演示',
      ...
      'toolbox.gameTool.subtitle': '记牌算牌助手',
      'toolbox.gameTool.title': '游戏辅助',
      'toolbox.gameTool.description': '帮你在围棋、象棋、德扑、掼蛋、麻将里面记牌和算牌。',
      'toolbox.gameTool.link': '打开工具',
      'toolbox.sixPoker.subtitle': '天津经典牌类游戏',
      'toolbox.sixPoker.title': '天津砸六家',
      'toolbox.sixPoker.description': '天津经典牌类游戏“打六家”，也叫砸六家，趣味性非常高，支持单机和电脑对局，也支持联机组网游戏。',
      'toolbox.sixPoker.link': '进入游戏',
